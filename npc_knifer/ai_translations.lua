...
function SWEP:SetupWeaponHoldTypeForAI( t )
	...
	self.ActivityTranslateAI [ ACT_IDLE_RELAXED ] 				= ACT_IDLE_ANGRY_MELEE
	...
	self.ActivityTranslateAI [ ACT_IDLE ] 						= ACT_HL2MP_IDLE_MELEE
	self.ActivityTranslateAI [ ACT_IDLE_ANGRY ] 				= ACT_HL2MP_IDLE_MELEE
	self.ActivityTranslateAI [ ACT_IDLE_RELAXED ] 				= ACT_HL2MP_IDLE_MELEE
	self.ActivityTranslateAI [ ACT_IDLE_STIMULATED ] 			= ACT_HL2MP_IDLE_MELEE
	self.ActivityTranslateAI [ ACT_IDLE_AGITATED ] 				= ACT_HL2MP_IDLE_MELEE
	self.ActivityTranslateAI [ ACT_IDLE_AIM_RELAXED ] 			= ACT_HL2MP_IDLE_MELEE
	self.ActivityTranslateAI [ ACT_IDLE_AIM_STIMULATED ] 		= ACT_HL2MP_IDLE_MELEE
	self.ActivityTranslateAI [ ACT_IDLE_AIM_AGITATED ] 			= ACT_HL2MP_IDLE_MELEE
